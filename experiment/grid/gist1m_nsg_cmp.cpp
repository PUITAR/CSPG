...
#if defined (BASELINE)
const std::string csv_path_baseline = "output/grid/gist1m_nsg_cmp_baseline.csv";
#endif
#if defined (PARALLEL)
const size_t part = 2;
const std::string csv_path_parallel = "output/grid/gist1m_nsg_cmp_cspg_"+std::to_string(part)+".csv";
#endif
