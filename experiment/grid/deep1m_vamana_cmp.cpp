...
#if defined (BASELINE)
const std::string csv_path_baseline = "output/grid/deep1m_vamana_cmp_baseline.csv";
#endif
#if defined (PARALLEL)
const size_t part = 2;
const std::string csv_path_parallel = "output/grid/deep1m_vamana_cmp_cspg_"+std::to_string(part)+".csv";
#endif
