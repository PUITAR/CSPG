...
#if defined (BASELINE)
const std::string csv_path_baseline = "output/distribution/gcd_vamana_baseline.csv";
#endif
#if defined (PARALLEL)
const size_t part = 2;
const std::string csv_path_parallel = "output/distribution/gcd_vamana_cspg_"+std::to_string(part)+".csv";
#endif
