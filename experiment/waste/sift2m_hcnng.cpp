...
// Files
const std::string base_vectors_path = "/var/lib/docker/anns/dataset/sift10m/base2m.bvecs";
const std::string queries_vectors_path = "/var/lib/docker/anns/query/sift10m/query.bvecs";
const std::string groundtruth_path = "/var/lib/docker/anns/query/sift10m/gt2m.ivecs";

const std::string csv_path_baseline= "output/waste/sift2m_hcnng_baseline.csv";
