...
// Files
const std::string base_vectors_path = "/var/lib/docker/anns/dataset/sift100m/base.bvecs";
const std::string queries_vectors_path = "/var/lib/docker/anns/query/sift100m/query.bvecs";
const std::string groundtruth_path = "/var/lib/docker/anns/query/sift100m/gt.ivecs";

#if defined (BASELINE)
const std::string csv_path_baseline = "output/hard/sift100m_vamana_baseline.csv";
#endif
#if defined (PARALLEL)
const size_t part = 2;
const std::string csv_path_parallel = "output/hard/sift100m_vamana_cspg_"+std::to_string(part)+".csv";
#endif
