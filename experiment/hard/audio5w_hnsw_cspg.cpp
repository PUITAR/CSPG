...
const size_t part = 2;
const std::string csv_path_parallel = "output/hard/audio5w_hnsw_cspg_" + std::to_string(part) + ".csv";
...
int main()
{
  ...
  csv_parallel << "index_type,num_partition,max_degree,efc,build_time,index_size,num_queries,k,efq,query_time,comparison,recall" << std::endl;
