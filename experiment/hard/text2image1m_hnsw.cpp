...
#if defined (BASELINE)
const std::string csv_path_baseline = "output/hard/text2image1m_hnsw_baseline.csv";
#endif

#if defined (PARALLEL)
const size_t part = 2;
const std::string csv_path_parallel = "output/hard/text2image1m_hnsw_cspg_"+std::to_string(part)+".csv";
#endif
