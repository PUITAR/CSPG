...
// Files
const std::string base_vectors_path = "/home/dbcloud/big-ann-benchmarks/data/MSTuringANNS/base1b.fbin.crop_nb_1000000";
const std::string queries_vectors_path = "/home/dbcloud/big-ann-benchmarks/data/MSTuringANNS/testQuery10K.fbin";
const std::string groundtruth_path = "/home/dbcloud/big-ann-benchmarks/data/MSTuringANNS/testQuery10K_gt.ivecs";

#if defined (BASELINE)
const std::string csv_path_baseline = "output/hard/turing1m_vamana_baseline.csv";
#endif
#if defined (PARALLEL)
const size_t part = 2;
const std::string csv_path_parallel = "output/hard/turing1m_vamana_cspg_"+std::to_string(part)+".csv";
#endif
