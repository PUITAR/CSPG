# PuiANN Library Usage

Here is an example of how to use the PuiANN library to create a simple neural network and train it to classify handwritten digits:
