...
//         size_t random_seed) : D_(D), max_elements_(max_elements), M_(M), Mmax_(M), Mmax0_(2 * M),
...
//     template <typename vdim_t>
//     inline const vdim_t *
//     HNSW<vdim_t>::GetDataByInternalID(id_t id) const
//     {
...
//     template <typename vdim_t>
//     void
//     HNSW<vdim_t>::WriteDataByInternalID(id_t id, const vdim_t *data_point)
//     {
...
//     template <typename vdim_t>
//     inline char *
//     HNSW<vdim_t>::GetLinkByInternalID(id_t id, int level) const
//     {
//       if (level > 0)
...
//     HNSW<vdim_t>::SearchBaseLayer(id_t ep_id, const vdim_t *data_point, int level, size_t ef)
//     {
//       size_t comparison = 0;
...
//     template <typename vdim_t>
//     void
//     HNSW<vdim_t>::GetNeighborsByHeuristic(std::priority_queue<std::pair<float, id_t>> &top_candidates, size_t NN)
//     {
...
//     template <typename vdim_t>
//     id_t
//     HNSW<vdim_t>::MutuallyConnectNewElement(
...
//     template <typename vdim_t>
//     void
//     HNSW<vdim_t>::AddPoint(const vdim_t *data_point)
//     {
...
//     template <typename vdim_t>
//     std::priority_queue<std::pair<float, id_t>>
//     HNSW<vdim_t>::Search(const vdim_t *query_data, size_t k, size_t ef)
//     {
...
//     template <typename vdim_t>
//     std::priority_queue<std::pair<float, id_t>>
//     HNSW<vdim_t>::Search(const vdim_t *query_data, size_t k, size_t ef, id_t ep)
//     {
//       assert(ready_ && "Index uninitialized!");
...
//     template <typename vdim_t>
//     int
//     HNSW<vdim_t>::GetRandomLevel(double reverse_size)
//     {
...
//     template <typename vdim_t>
//     void
//     HNSW<vdim_t>::Populate(const std::vector<vdim_t> &raw_data)
//     {
...
//     template <typename vdim_t>
//     void
//     HNSW<vdim_t>::Populate(const std::vector<const vdim_t *> &raw_data)
//     {
...
//     template <typename vdim_t>
//     bool
//     HNSW<vdim_t>::Ready() { return ready_; }

//     template <typename vdim_t>
//     size_t
//     HNSW<vdim_t>::GetNumThreads() { return num_threads_; }

//     template <typename vdim_t>
//     void
//     HNSW<vdim_t>::SetNumThreads(size_t num_threads) { num_threads_ = num_threads; }

//     template <typename vdim_t>
//     void HNSW<vdim_t>::SetReady(bool ready) { ready_ = ready; }

//     template <typename vdim_t>
//     size_t HNSW<vdim_t>::GetComparisonAndClear()
//     {
//       return comparison_.exchange(0);
//     }

//     template <typename vdim_t>
//     size_t HNSW<vdim_t>::IndexSize() const
//     {
//       size_t sz = 0;
...
//     template <typename vdim_t>
//     id_t HNSW<vdim_t>::GetClosestPoint(const vdim_t *data_point)
//     {
//       if (cur_element_count_ == 0)
...
//     template <typename vdim_t>
//     std::vector<float>
//     HNSW<vdim_t>::GetSearchLengthLevel0(id_t ep_id,
//                                         const vdim_t *query_data, size_t k, size_t ef, std::priority_queue<std::pair<float, id_t>> &top_candidates)
//     {
...
//     template <typename vdim_t>
//     std::vector<float>
//     HNSW<vdim_t>::GetSearchLength(const vdim_t *query_data, size_t k, size_t ef, std::priority_queue<std::pair<float, id_t>> &top_candidates)
//     {
//       assert(ready_ && "Index uninitialized!");
